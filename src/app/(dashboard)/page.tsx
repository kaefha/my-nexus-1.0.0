...
export default function DashboardPage() {
 ...
 {
 title: 'On Delivery',
 value: kpi.onDelivery,
 icon: Truck,
 change: `${kpi.onDelivery} shipments`,
 changePositive: true,
 },
 {
 ...
 Overview of your network inventory operations
 </p>
 </div>
 </div>
 ...
 return (
 <Card key={card.title} className="animate-fade-in " style={{ animationDelay: `${index * 80}ms` }}>
